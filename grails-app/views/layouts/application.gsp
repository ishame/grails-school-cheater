            ...
            <ul class="nav navbar-nav navbar-right">
                <sec:ifLoggedIn>
                    ...
                    <li><g:link controller="profile">
                        <g:message code="dashboard.profile.label"/>
                    </g:link></li>
                    <li><g:link uri="/">
                        <g:message code="dashboard.help.label"/>
                    </g:link></li>
        ...
        <sec:ifLoggedIn>
            <div class="col-sm-3 col-md-2 sidebar">
                <strong class="navbar__title"><span class="glyphicon glyphicon-adjust"></span>&nbsp;
                    <g:message code="dashboard.navBar.create.title"/></strong>
                <ul class="nav nav-sidebar">
                    <li>
                        <g:link controller="startPage">
                            <span class="glyphicon glyphicon-star"></span>&nbsp;
                            <g:message code="dashboard.navBar.startPage.label"/>
                        </g:link></li>
                    <li>
                        <g:link controller="questions">
                            <span class="glyphicon glyphicon-question-sign"></span>&nbsp;
                            <g:message code="dashboard.navBar.questions.label"/>
                        </g:link>
                    </li>
                </ul>
                <strong class="navbar__title"><span class="glyphicon glyphicon-signal"></span>&nbsp;
                <g:message code="dashboard.navBar.analyze.title"/>
                </strong>
                <ul class="nav nav-sidebar">
                    <li>
                        <g:link controller="grading">
                            <span class="glyphicon glyphicon-grain"></span>&nbsp;
                            <g:message code="dashboard.navBar.grading.label"/>
                        </g:link></li>
                    <li>
                        <g:link controller="certification">
                            <span class="glyphicon glyphicon-certificate"></span>&nbsp;
                            <g:message code="dashboard.navBar.certification.label"/>
                        </g:link>
                    </li>
                </ul>
                <strong class="navbar__title"><span class="glyphicon glyphicon-cog"></span>&nbsp;
                    <g:message code="dashboard.navBar.settings.title"/></strong>
                <ul class="nav nav-sidebar">
                    <li>
                        <g:link controller="styling">
                            <span class="glyphicon glyphicon-stats"></span>&nbsp;
                            <g:message code="dashboard.navBar.styling.label"/>
                        </g:link></li>
                    <li>
                        <g:link controller="resultPage">
                            <span class="glyphicon glyphicon-resize-full"></span>&nbsp;
                            <g:message code="dashboard.navBar.resultPage.label"/>
                        </g:link>
                    </li>
                </ul>
            </div>
